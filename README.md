...
1. How would you describe acessibility on the web to someone new to programming?
	...
	Accessability is the practice of making your website as usable as possible for as many people as possible.

2. Talk about 3 different things you can do to ensure your website is accessible. 

	 Using discriptive alt tags in images so that they can be interpreted by screenreaders, using semantic HTML, or designing your website for multiple screen sizes. 

3. How would you explain the concept of a variable to someone new to programming?

	A variable is a way to contain information within a program, and then name that collected information whatever you want.

4. What is the purpose of using functions in code?

	Functions are like a set of directions for your code, you can tell your program what to do through a function.
